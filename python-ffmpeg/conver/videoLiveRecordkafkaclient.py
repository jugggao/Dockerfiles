...
import transvideoliverecord
from ReadConfig import ReadConfigFile

# connect to Kafka server and pass the topic we want to consume
consumer = KafkaConsumer('translateLiveVideo', group_id='ambow_getaway',
...
def test():
    ...
    try:
        for msg in consumer:
            ...
            transvideoliverecord.translate_mp4(url, redirect_url, randomPath)
